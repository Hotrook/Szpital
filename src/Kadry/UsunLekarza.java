...
public class UsunLekarza extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UsunLekarza frame = new UsunLekarza();
	...
	public UsunLekarza() {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String query = "DELETE FROM Lekarz WHERE Imie = '" + im +"' AND Nazwisko = '" + nazw + "'";
				System.out.println(query);
				
				Mquery.main();
				Mquery.update(query);
				
				JOptionPane.showMessageDialog(contentPane, "Lekarz usunięty");
				setVisible(false);
		...
		btnWr.setBounds(327, 231, 117, 29);
