...
public class ZarejestrujPacjenta extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ZarejestrujPacjenta frame = new ZarejestrujPacjenta();
	...
	public ZarejestrujPacjenta() {
		...
		btnOk.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String query = "INSERT INTO Pacjent (Imie,Nazwisko) "
						+ "VALUES ('"+im+"','"+nazw+"')";
				...
				JOptionPane.showMessageDialog(contentPane, "Pacjent zarejestrowany");
				setVisible(false);
			}
		});
		...
		btnWr.setBounds(327, 158, 117, 29);
