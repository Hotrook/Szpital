...
public class DodajChorobe extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DodajChorobe frame = new DodajChorobe();
	...
	public DodajChorobe() {
		...
		lblStopieZagroenia.setBounds(81, 147, 146, 16);
		contentPane.add(lblStopieZagroenia);
		
		stopien = new JTextField();
		stopien.setBounds(239, 142, 130, 26);
		...
		ok.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String query = "INSERT INTO Choroba (Nazwa,Stopien_Zagrozenia) VALUES ('" + naz + "'," + stop+")";
				System.out.println(query);
				
				Mquery.main();
				Mquery.update(query);
				
				JOptionPane.showMessageDialog(contentPane, "Choroba dodana");
				setVisible(false);
			}
		});
		...
		btnWr.setBounds(377, 325, 117, 29);
